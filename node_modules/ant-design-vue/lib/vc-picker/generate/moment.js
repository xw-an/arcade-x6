  ...
  toDate: function toDate(value, valueFormat) {
    if (Array.isArray(value)) {
      return value.map(function (val) {
        return typeof val === 'string' && val ? (0, _moment.default)(val, valueFormat) : val || null;
      });
    } else {
      return typeof value === 'string' && value ? (0, _moment.default)(value, valueFormat) : value || null;
    }
  },
  toString: function toString(value, valueFormat) {
    if (Array.isArray(value)) {
      return value.map(function (val) {
        return _moment.default.isMoment(val) ? val.format(valueFormat) : val;
      });
    } else {
      return _moment.default.isMoment(value) ? value.format(valueFormat) : value;
    }
  }
};
