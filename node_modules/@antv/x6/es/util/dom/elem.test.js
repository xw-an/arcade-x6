...
import { ensureId, isSVGGraphicsElement, remove, tagName, createElement, } from './elem';
    ...
    describe('elem', () => {
        ...
        describe('#isSVGGraphicsElement', () => {
            ...
            it('should return false when the given element is not a SVGGraphicsElement', () => {
                ...
                expect(isSVGGraphicsElement(Vector.create('linearGradient').node)).toBe(false);
            });
        });
        describe('#index', () => {
        ...
        describe('#append', () => {
            const group = Vector.create(createElement('g'));
