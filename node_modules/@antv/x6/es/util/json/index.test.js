...
describe('JSONExt', () => {
    ...
    describe('deepEqual()', () => {
        it('should compare two JSON values for deep equality', () => {
            ...
            expect(JSONExt.deepEqual({ a: { b: null } }, { a: { b: null } })).toEqual(true);
            expect(JSONExt.deepEqual({ a: '1' }, { a: '1' })).toEqual(true);
            expect(JSONExt.deepEqual({ a: { b: null } }, { a: { b: '1' } })).toEqual(false);
    ...
    describe('deepCopy()', () => {
        it('should deep copy an object', () => {
            ...
            const v4 = 'foo';
            const v5 = 42;
            const v6 = [1, 2, 3, [4, 5, 6], { a: 12, b: [4, 5] }, false];
            const v7 = { a: false, b: [null, [1, 2]], c: { a: 1 } };
