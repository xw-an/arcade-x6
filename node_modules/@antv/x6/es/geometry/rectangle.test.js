...
describe('rectangle', () => {
    ...
    describe('#Rectangle.isRectangleLike', () => {
        it('should return true if the given object is a rectangle-like object', () => {
            ...
            expect(Rectangle.isRectangleLike(Object.assign(Object.assign({}, obj), { z: 10 }))).toBeTrue();
            expect(Rectangle.isRectangleLike(Object.assign(Object.assign({}, obj), { z: 10, s: 's' }))).toBeTrue();
        });
    ...
    describe('#bbox', () => {
        ...
        it('should rotate the rectangle if angle specified.', () => {
            ...
            expect(rect.bbox(90).round().equals(new Rectangle(-1, 1, 4, 2))).toBeTrue();
        });
    });
    describe('#add', () => {
    ...
    describe('#containsRect', () => {
        it('should return true when rect is completely inside the other rect', () => {
            expect(new Rectangle(50, 50, 100, 100).containsRect(60, 60, 80, 80)).toBeTrue();
        });
        ...
        it('should return false when rect is not inside the other rect', () => {
            expect(new Rectangle(50, 50, 100, 100).containsRect(20, 20, 200, 200)).toBeFalse();
            expect(new Rectangle(50, 50, 100, 100).containsRect(40, 40, 100, 100)).toBeFalse();
            expect(new Rectangle(50, 50, 100, 100).containsRect(60, 60, 100, 40)).toBeFalse();
            expect(new Rectangle(50, 50, 100, 100).containsRect(60, 60, 100, 100)).toBeFalse();
            expect(new Rectangle(50, 50, 100, 100).containsRect(60, 60, 40, 100)).toBeFalse();
        });
        it('should return false when one of the dimensions is `0`', () => {
            expect(new Rectangle(50, 50, 100, 100).containsRect(75, 75, 0, 0)).toBeFalse();
